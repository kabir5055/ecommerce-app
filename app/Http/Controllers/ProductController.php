...
//            'productSubImage' => ProductSubImage::select('sub_image')->where('product_id',$id)->get()->toArray(),
    ...
    public function update(Request $request, string $id)
    {
        ...
        Product::updateUploadImage($request,$productId);
        $colors=count($request->color_id);
        Product::updateColor($request,$productId,$colors);
        $sizes=count($request->size_id);
        Product::updateSize($request,$productId,$sizes);
