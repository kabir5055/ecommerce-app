                            ...
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ route('admin.color.index') }}" class="btn btn-success float-end">Manage Color</a>
                                        </div>
                                    </div>
                                    <hr/>
                                    <form class="row g-3" action="{{ isset($color) ? route('admin.color.update',$color->id) : route('admin.color.store') }}" method="post">
                                        @if(isset($color))
                                            @method('put')
                                        @endif
                                        @csrf
