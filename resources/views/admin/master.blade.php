...
<head>
    ...
    <link href="{{ asset('admin-asset') }}/assets/plugins/select2/css/select2.min.css" rel="stylesheet" />
    <link href="{{ asset('admin-asset') }}/assets/plugins/select2/css/select2-bootstrap4.css" rel="stylesheet" />
...
<script src="{{ asset('admin-asset') }}/assets/plugins/select2/js/select2.min.js"></script>
<script src="{{ asset('admin-asset') }}/assets/js/form-select2.js"></script>
...
<script>
    ...
    $('.fixed').click(function () {
        $('#fixedAmount').show();
        $('#percentageAmount').hide();
    });

    $('#percentageAmount').hide();
    $('.percentage').click(function () {
        $('#percentageAmount').show();
        $('#fixedAmount').hide();
    });
...
<script>
    ...
    function discountFixedAmount() {
        var price = document.getElementById('price').value;
        var disAmount = document.getElementById('disAmount').value;
        document.getElementById('disPrice').value= price - disAmount;
    }

    function disPercentageAmount() {
        var price = document.getElementById('price').value;
        var disPercentage = document.getElementById('disPercentage').value;
        document.getElementById('disPrice').value= price - price * disPercentage /100;
    }
