                            ...
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ route('admin.supplier.index') }}" class="btn btn-success float-end">Manage supplier</a>
                                        </div>
                                    </div>
                                    <hr/>
                                    <form class="row g-3" action="{{ isset($supplier) ? route('admin.supplier.update',['supplier'=>$supplier->id]) : route('admin.supplier.store')}}" method="post" enctype="multipart/form-data">
                                        @if(isset($supplier))
                                            @method('put')
                                        @endif
                                        @csrf
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" name="supplier_name" value="{{ isset($supplier) ? $supplier->supplier_name: ' ' }}">
                                        </div>
                                        <div class="col-12">
